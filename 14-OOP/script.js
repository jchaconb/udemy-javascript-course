...
const PersonP1 = function (firstName, birthYear) {
  this.firstName = firstName;
  this.birthYear = birthYear;
};

PersonP1.prototype.calcAge = function () {
  console.log(2037 - this.birthYear);
};

const Student = function (firstName, birthYear, course) {
  PersonP1.call(this, firstName, birthYear);
  this.course = course;
};

// Linking prototypes
Student.prototype = Object.create(PersonP1.prototype);
...
console.log(mike instanceof PersonP1);
...
const CarC1 = function (make, speed) {
  this.make = make;
  this.speed = speed;
};

CarC1.prototype.accelerate = function () {
  this.speed += 10;
  console.log(`${this.make} is going at ${this.speed} km/h`);
};

CarC1.prototype.brake = function () {
  this.speed -= 5;
  console.log(`${this.make} is going at ${this.speed} km/h`);
};

const EV = function (make, speed, charge) {
  CarC1.call(this, make, speed);
  this.charge = charge;
};

// Link the prototypes
EV.prototype = Object.create(CarC1.prototype);
...
class StudentKl extends PersonKl {
